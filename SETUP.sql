...
CREATE OR REPLACE SCHEMA MARKETING_CAMPAIGNS_DB.TEST;
USE SCHEMA MARKETING_CAMPAIGNS_DB.TEST;
...
GRANT USAGE ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
GRANT CREATE TABLE ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
GRANT CREATE STAGE ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
...
-- Create Datasets
GRANT CREATE FILE FORMAT ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
GRANT CREATE DATASET ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;

-- Create and execute tasks
GRANT CREATE TASK ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
GRANT EXECUTE TASK ON ACCOUNT TO ROLE AGENT_EVAL_ROLE;

-- Run evaluations
GRANT MONITOR ON FUTURE AGENTS IN SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
...
GRANT CREATE GIT REPOSITORY ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;

-- Service and Agent creation
GRANT CREATE SEMANTIC VIEW ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
GRANT CREATE CORTEX SEARCH SERVICE ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
GRANT CREATE PROCEDURE ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
GRANT CREATE AGENT ON SCHEMA MARKETING_CAMPAIGNS_DB.TEST TO ROLE AGENT_EVAL_ROLE;
...
FROM SPECIFICATION $$
{
    ...
    "tool_resources": {
        "query_performance_metrics": {
            ...
            "semantic_view": "MARKETING_CAMPAIGNS_DB.TEST.MARKETING_PERFORMANCE_ANALYST"
        },
        "search_campaign_content": {
            ...
            "search_service": "MARKETING_CAMPAIGNS_DB.TEST.MARKETING_CAMPAIGNS_SEARCH"
        },
        "generate_campaign_report": {
            "type": "procedure",
            "identifier": "MARKETING_CAMPAIGNS_DB.TEST.GENERATE_CAMPAIGN_REPORT_HTML",
            "execution_environment": {
                "type": "warehouse",
                "warehouse": "COMPUTE_WH",
                "query_timeout": 300
...
- Navigate to your newly created agent and click into Evaluations Tab
    ...
    - Select Create New Dataset
        - Select MARKETING_CAMPAIGNS_DB.TEST.EVALS_TABLE as your input table
        - Select MARKETING_CAMPAIGNS_DB.TEST.QUICKSTART_EVALSET as your new dataset destination [click next]
